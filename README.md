...
See [SETTINGS.md](SETTINGS.md) for all full configurable options.
...
In the future I may support automatically loading syntaxes from [bat](https://github.com/sharkdp/bat/) if it is installed on the system. It is fairly trivial, but revisa uses an unreleased version of syntect and the dumps are not compatible. Ping me when bat is using syntect v6 if you want this feature.
